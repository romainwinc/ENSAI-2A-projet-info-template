...
class TestIngredientService(unittest.TestCase):
    def setUp(self):
        ...
        # Création de l'instance de IngredientService avec les mocks
    ...
    def test_recuperer_ingredients_favoris_utilisateur(self, mock_stdout):
        ...
        self.ingredient_service.recuperer_ingredients_favoris_utilisateur(utilisateur_id=1)
    ...
    def test_supprimer_ingredients_favoris(self, mock_stdout):
        ...
        self.ingredient_service.supprimer_ingredients_favoris(utilisateur_id=1, ingredient_id=2)
    ...
    def test_ajouter_ingredients_favoris(self, mock_stdout):
        self.ingredients_favoris_dao_mock.add_favori.return_value = True  # Assurez-vous que la méthode est correcte

        self.ingredient_service.ajouter_ingredients_favoris(utilisateur_id=1, ingredient_id=2)
    ...
    def test_recuperer_ingredients_non_desires_utilisateur(self, mock_stdout):
        ...
        self.ingredient_service.recuperer_ingredients_non_desires_utilisateur(utilisateur_id=1)
    ...
    def test_supprimer_ingredients_non_desires(self, mock_stdout):
        ...
        self.ingredient_service.supprimer_ingredients_non_desires(utilisateur_id=1, ingredient_id=2)
    ...
    def test_ajouter_ingredients_non_desires(self, mock_stdout):
        ...
        self.ingredient_service.ajouter_ingredients_non_desires(utilisateur_id=1, ingredient_id=2)

        self.ingredients_non_desires_dao_mock.add_ingredient_non_desire.assert_called_once_with(1, 2)
    ...
    def test_afficher_ingredients_liste_courses(self, mock_stdout):
        ...
        self.ingredient_service.afficher_ingredients_liste_courses(utilisateur_id=1)
    ...
    def test_supprimer_ingredients_liste_courses(self, mock_stdout):
        ...
        self.ingredient_service.supprimer_ingredients_liste_courses(utilisateur_id=1, recette_id=1, ingredient_id=2)

        self.liste_de_courses_dao_mock.delete_from_liste.assert_called_once_with(2, 1, 1)

        # Vérification de l'impression
        mock_stdout.assert_called_with(f"L'ingrédient avec l'ID 2 a été supprimé de la liste de courses.")
    ...
    def test_ajouter_ingredients_liste_courses(self, mock_stdout):
        ...
        self.ingredient_service.ajouter_ingredients_liste_courses(utilisateur_id=1, recette_id=1, ingredient_id=2)

        self.liste_de_courses_dao_mock.add_liste_de_courses.assert_called_once_with(2, 1, 1)

        # Vérification de l'impression
        mock_stdout.assert_called_with(f"L'ingrédient avec l'ID 2 a été ajouté à la liste de courses.")

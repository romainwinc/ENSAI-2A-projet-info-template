...
class DemandeChangerRole(VueAbstraite):
    """Vue pour effectuer une demande pour passer professionnel ou administrateur."""
    ...
    def choisir_menu(self):
        ...
        type_demande = inquirer.select(
            ...
            choices=["Passer professionnel", "Passer administrateur"],
        ).execute()
        attribut_modifie = "role"
        if type_demande == "Passer professionnel":

class IngredientService:
    def __init__(self, ingredient_dao, ingredients_favoris_dao, ingredients_non_desires_dao, liste_de_courses_dao):
        self.ingredient_dao = ingredient_dao
        self.ingredients_favoris_dao = ingredients_favoris_dao
        self.ingredients_non_desires_dao = ingredients_non_desires_dao
        self.liste_de_courses_dao = liste_de_courses_dao
    ...
    def recuperer_ingredients_favoris_utilisateur(self, utilisateur_id: int):
        ...
        if not ingredients_favoris:
            print("Vous n'avez aucun ingrédient favori.")
            return
    ...
    def ajouter_ingredients_favoris(self, utilisateur_id: int, ingredient_id: int):
        ...
        success = self.ingredients_favoris_dao.add_favori(utilisateur_id, ingredient_id)
        if success:
    ...
    def recuperer_ingredients_non_desires_utilisateur(self, utilisateur_id: int):
        ...
        ingredients_non_desires = self.ingredients_non_desires_dao.get_non_desires_by_user_id(utilisateur_id)
    ...
    def ajouter_ingredients_non_desires(self, utilisateur_id: int, ingredient_id: int):
        ...
        success = self.ingredients_non_desires_dao.add_ingredient_non_desire(utilisateur_id, ingredient_id)
        if success:
    ...
    def supprimer_ingredients_liste_courses(self, utilisateur_id: int, recette_id: int, ingredient_id: int):
        """Supprime un ingrédient de la liste de courses d'un utilisateur."""
        success = self.liste_de_courses_dao.delete_from_liste(ingredient_id, recette_id, utilisateur_id)
        if success:
    ...
    def ajouter_ingredients_liste_courses(self, utilisateur_id: int, recette_id: int, ingredient_id: int):
        """Ajoute un ingrédient à la liste de course d'un utilisateur."""
        success = self.liste_de_courses_dao.add_liste_de_courses(ingredient_id, recette_id, utilisateur_id)
        if success:
